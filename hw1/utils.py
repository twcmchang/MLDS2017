...
class TextLoader():
    def __init__(self, data_dir, batch_size, seq_length, max_vocab_size):
    ...
    def build_vocab(self, sentences):
        ...
        # 187802
        vocabulary_inv = [x[0] for x in word_counts.most_common()][0:(self.vocab_size-1)]
